...
namespace WinPublishHelpTool.Tools
{
    ...
    public class XmlHelper
    {
        ...
        public XmlNode SerializeXmlNode<T>(T projectInfo)
        {
            ...
            {
                xmlNode = _xml.CreateNode(XmlNodeType.Element, type.Name,null);
                foreach (var pro in properties)
                {
                    if (pro.GetCustomAttribute(typeof(CustomeNoSerializeAttribute)) != null)
                    {
                        continue;
                    }
                    var newNode = _xml.CreateNode(XmlNodeType.Element, pro.Name, null);
                    newNode.InnerText = pro.GetValue(projectInfo, null).ToString();
